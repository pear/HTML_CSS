<?php
/**
 * API removeGroupSelector Unit tests for HTML_CSS class.
 *
 * @version    $Id$
...
class HTML_CSS_TestCase_removeGroupSelector extends PHPUnit_TestCase
{
    ...
    function test_removeGroupSelector_fail_selectors_no_string()
    {
        ...
        $val = $this->stylesheet->removeGroupSelector($group, true);
        $this->_getResult($val);
    }

    function test_removeGroupSelector_fail_invalid_groupid()
    {
